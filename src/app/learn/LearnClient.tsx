...
export function LearnClient({ articles }: { articles: Article[] }) {
    ...
    <div className="pt-20">
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-8 lg:px-12 text-center">
          <h1 className="text-4xl font-bold text-slate-900 mb-4">安卓学习</h1>
          <p className="text-slate-600 max-w-2xl mx-auto">从零开始，深入理解安卓系统架构设计思想</p>
        </div>
      </section>
